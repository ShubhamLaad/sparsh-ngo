  ...
  return (
    <footer>
      <Container className="d-flex">
        <p>© 2016 Sparsh NGO</p>
        <a className="developer" rel="noopener noreferrer" href="https://www.linkedin.com/in/shubhamlaad" target="_blank">Developed By<div className="shubham"> Shubham Laad</div></a>
